...
static add(params: {
      ...
      /** requestBody */
      body?:UserAdd,
          } = {} as any,options:IRequestOptions={}):Promise<user> {
 ...
 * 短信验证码登录
 */
static viaSms(params: {
              
      /** requestBody */
      body?:AuthViaSMS,
          } = {} as any,options:IRequestOptions={}):Promise<jwt> {
  return new Promise((resolve, reject) => {
 ...
 * 提交创建新申请
 */
static submitNewShipForApproval(params: {
...
static search(params: {
    ...
    /** 船只中文名称 */
    name:string,
          } = {} as any,options:IRequestOptions={}):Promise<shipDetail[]> {
  return new Promise((resolve, reject) => {
...
static detail(params: {
    ...
    /** 订单id */
    orderId:string,
          } = {} as any,options:IRequestOptions={}):Promise<orderDetail> {
  return new Promise((resolve, reject) => {
 ...
 * 拉取维保任务的检查/履约项
 */
static fetchEntries(params: {
              
    /** 维保任务的id */
    taskId:number,
          } = {} as any,options:IRequestOptions={}):Promise<smTaskEntries> {
  return new Promise((resolve, reject) => {
  ...
  export enum EnumuserGender{
        'unkown'='unkown','male'='male','femal'='femal'
      }export enum EnumnewUserInputGender{
        'unkown'='unkown','male'='male','femal'='femal'
      }export enum EnumnewUserInputRoles{
        'PlatformAdmin'='PlatformAdmin','SalesRep'='SalesRep','SMOperator'='SMOperator','SMCoordinator'='SMCoordinator','ShipyardLiason'='ShipyardLiason'
      }export enum EnumshipDetailType{
        '干货船'='干货船','散装化学品船/油船'='散装化学品船/油船','其他'='其他'
      }
  export enum orderStatus{
    'Executing'='Executing','Abnormal'='Abnormal','Awaiting'='Awaiting','Fulfilled'='Fulfilled'
  }
  export enum EnumdeviceType{
        '超高压泵组'='超高压泵组','手持枪'='手持枪','直线式清洗盘'='直线式清洗盘','轮式船底小车'='轮式船底小车','真空回收装置'='真空回收装置','超高压水管'='超高压水管','污水净化设备'='污水净化设备'
      }export enum EnumsmTaskType{
        '业前检查'='业前检查','日常保养'='日常保养','日常巡检'='日常巡检','定期保养'='定期保养','设备维修'='设备维修','结业锁机'='结业锁机'
